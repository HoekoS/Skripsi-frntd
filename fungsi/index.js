const url_dash = 'http://localhost:3737/api/dashboard';
var output = "";
var output2 = "";
var output3 = "";
...
function show(id,name,date){
  ...
  output +=
        `<li class="item">
        <a href="http://localhost:3737/bahan/bahan_detail.html?key=`+id+`" class="product-title">`+name+`
...
function showMenu(nama,dsc,prc,pic){
  ...
  output3 +=
        `<li>
        <img src="http://localhost:3838/`+pic+`" alt="User Image" style="height:100px">
